export const data = [
    ...
    },
    {
        ...
        ru: '- Положительный настрой;',
    },
    {
        en: '- Effective listening skills;',
        uk: '- Навички ефективного слухання;',
        ru: '- Навыки эффективного слушания;',
    },
    {
        en: '- Creative thinking skills;',
        uk: '- Навички творчого мислення;',
        ru: '- Навыки творческого мышления;',
    },
    {
        en: '- I work effectively in a team;',
        uk: '- Ефективно працюю в команді;',
        ru: '- Эффективно работаю в команде;',
    },
    {
        en: '- I work effectively in a individually;',
        uk: '- Ефективно працюю індивідуально;',
        ru: '- Эффективно работаю в индивидуальном порядке;',
    },
    {
        en: '- Calm;',
        uk: '- Спокійна;',
    ...
    },
    {
        ...
        uk: 'це сайт ресторану здорового харчування. У своїй роботі використовувала: HTML, CSS, JavaScript.',
        ru: 'это сайт ресторана здорового питания. В своей работе я использовала: HTML, CSS, JavaScript.',
    },
    {
    ...
    {
        en: 'is a page for finding various events in different countries of the world. On the project, I had the role of a team lead. We used: HTML, SASS, JavaScript, REST API, WEBPACK',
        uk: 'це сторінка для пошуку різноманітних подій у різних країнах світу. На проекті я виконував роль ліда команди. Ми використовували: HTML, SASS, JavaScript, REST API, WEBPACK',
        ru: 'это страница для поиска различных событий в разных странах мира. На проекте у меня была роль тимлида. Мы использовали: HTML, SASS, JavaScript, REST API, WEBPACK',
    },
    {
        en: 'EDUCATION',
        uk: 'ОСВІТА',
